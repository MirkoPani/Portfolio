...
export default Vue.extend({
	data() {
			return {
				...
				heroTitle: '<span class="align-middle">Ciao</span> <img class="h-20 inline" src="'+require("~/assets/icons/hand.svg")+'" />!', //<img class="h-20 inline" src="'+require("~/assets/icons/hand.svg")+'" />!
